# 💻 Cadeira de Engenharia de Software: Fundamentos - Unisinos

> Repositório dedicado a armazenar todos os projetos, atividades e anotações desenvolvidos ao longo do semestre na disciplina de **Engenharia de Software: Fundamentos** do curso de Ciência da Computação na Universidade do Vale do Rio dos Sinos (Unisinos).
